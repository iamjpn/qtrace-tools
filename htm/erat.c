/*
 * erat simulates the operation of the radix tlb. This is done in an indirect
 * way as the state of the tlb is not included in the HTM trace. The HTM trace
 * includes effective and real addresses for all memory accesses. erat uses
 * these to return a full radix walk for qtrace output.
 *
...
/* eara_cache is the eara cache for a trace. */
